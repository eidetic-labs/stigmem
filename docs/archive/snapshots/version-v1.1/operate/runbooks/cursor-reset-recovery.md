...
- [Federation guide](../../build/guides/federation) — peer registration, pull loop, and scope enforcement
- [4-node soak results](../../build/guides/federation#soak-results) — cursor-resume behavior verified under failure injection
