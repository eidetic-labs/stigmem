...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/storage-libsql/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/storage-libsql-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-storage-libsql.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/storage-libsql/` |
