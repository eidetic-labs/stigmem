...
**Track:** F2 — [ACM-102](/ACM/issues/ACM-102) (pre-GA hardening)
...
- [Federation guide](./federation) — peer registration, pull loop, and scope enforcement
- [4-node soak results](./federation#soak-results) — cursor-resume behavior verified under failure injection
