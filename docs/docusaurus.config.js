...
const config = {
  ...
  plugins: [
    ...
    [
      ...
      {
        redirects: [
          // Redirects for the v2 IA restructure are generated by createRedirects()
          // below. They use the /docs/next/ prefix since v2.0-draft is the "current"
          // version. When v2.0 becomes lastVersion these will shift to /docs/.
          //
          // Legacy redirects (pre-learn/build era) point to v1.1 which is the
          // current default version and serves content at /docs/.
