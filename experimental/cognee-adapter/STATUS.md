...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/cognee-adapter/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/cognee-adapter-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-cognee-adapter.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/cognee-adapter/` |
