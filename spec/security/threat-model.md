...
| R-15 | T9-T1, T9-E1 | Instruction-scope write confers effective instruction-authoring authority over any agent using §21 lazy discovery | Low | Critical | High | §21.1, §3.5 | **Open** | Canonical feature analysis: [`experimental/lazy-instruction-discovery/security.md`](../../experimental/lazy-instruction-discovery/security.md). Protocol summary: operators must treat `instruction:` write as admin-equivalent until a dedicated `instruction_write` permission tier and admission gate exist. |
