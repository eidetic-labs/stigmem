...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/deploy-paas/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/deploy-paas-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-deploy-paas.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/deploy-paas/` |
