...
This starts four nodes (`node-a` through `node-d` on ports 8765–8768) in a full-mesh topology. See the [4-node topology guide](../../build/guides/federation-4node) for peer wiring, failure injection, and soak metrics.
