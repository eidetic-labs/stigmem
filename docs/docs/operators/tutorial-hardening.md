...
**The v0.9.0a7 reference image runs as UID/GID 65532 (non-root).**
...
```bash
docker pull ghcr.io/eidetic-labs/stigmem-node:0.9.0a7
...
cosign verify \
  ...
  ghcr.io/eidetic-labs/stigmem-node:0.9.0a7
```
