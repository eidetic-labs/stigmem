...
- [Observability](./observability.md) — Prometheus metrics and OpenTelemetry tracing
- [Security section](/docs/security) — threat model and pen-test handbook
- [Conformance guide](../guides/conformance.md) — spec conformance testing
