...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/multi-tenant/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/multi-tenant-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-multi-tenant.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/multi-tenant/` |
