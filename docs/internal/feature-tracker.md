...
| `openai-tools-adapter` | OpenAI tools adapter | `adapter` | `experimental` | `external` | `none` | `experimental/openai-tools-adapter/` | `features/openai-tools-adapter/` | `migrated` | `future alpha` | OpenAI-compatible tool-use adapter; live provider validation remains future alpha work. |
...
| `eval-harness` | Evaluation harness | `tooling` | `experimental` | `internal` | `none` | `experimental/eval-harness/` | `features/eval-harness/` | `migrated` | `future alpha` | Concept-only evaluation tooling; runnable harness remains future alpha work. |
