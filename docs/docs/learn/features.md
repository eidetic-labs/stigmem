...
|-------------------------------------|------------|-----------|----------------------------------------|
| Immutable typed facts (entity, relation, value, source, timestamp, confidence, scope) | Stable | §2, §3    | [Asserting facts](../build/guides/asserting-facts.md) |
| Scope enforcement (`local` / `team` / `company` / `public`) | Stable | §3.5      | [Scope propagation](../build/guides/scope-propagation.md) |
| Confidence + decay (`valid_until`, retraction) | Stable | §15       | [Decay guide](../build/guides/decay.md) |
| Synthesis (confidence-weighted current state) | Stable | §16       | [Synthesis guide](../build/guides/synthesis.md) |
| Conflict surfacing & resolution     | Stable     | §6.3      | [Conflict resolution](../build/guides/conflict-resolution.md) |
| Entity naming rules                 | Stable     | §2.5–§2.6 | [Asserting facts](../build/guides/asserting-facts.md) |
...
| Capability                          | Status     | Spec   | Docs                                |
|-------------------------------------|------------|--------|-------------------------------------|
| `POST /v1/recall` hybrid pipeline (lexical + dense + graph) | Stable | §20.3  | [Recall guide](../build/guides/recall.md) |
| Vector embeddings (sqlite-vec, nomic-embed-text-v1.5 default) | Stable | §20.2  | [Embeddings](../build/guides/embeddings.md) |
| Graph adjacency index (`GET /v1/graph/neighbors`) | Stable | §20.1  | [Recall guide](../build/guides/recall.md) |
...
| Causal links (`derived_from`)       | Stable     | §20.6  | [Recall guide](../build/guides/recall.md) |

## Federation

| Capability                          | Status     | Spec   | Docs                                |
|-------------------------------------|------------|--------|-------------------------------------|
| Two-node federation (Ed25519 handshake, HLC cursors) | Stable | §6     | [Federation guide](../build/guides/federation.md) |
| Pull replication                    | Stable     | §6     | [Federation setup](../operate/runbooks/federation-setup.md) |
| N-node soak (4-node topology)       | Stable     | §6.7–§6.8 | [4-node federation](../build/guides/federation-4node.md) |
| Cross-org capability tokens         | Stable     | §19    | [Federation Trust](../build/guides/federation-trust.md) |
| Org manifests + transparency log    | Stable     | §19    | [Federation Trust](../build/guides/federation-trust.md) |
| Source-trust score & quarantine garden | Stable  | §19    | [Federation Trust](../build/guides/federation-trust.md) |
| Recall-time content sanitizer       | Stable     | §19    | [Federation Trust](../build/guides/federation-trust.md) |
| mTLS for peer connections           | Stable     | §22.1  | [mTLS](../operate/security/mtls.md) |
...
| Cursor-checkpoint export/import     | Stable     | §6.6 | [Cursor reset recovery](../build/guides/cursor-reset-recovery.md) |
...
| Audit log (13 event types)          | Stable     | §22.3  | [Audit & quotas](../operate/security/audit-and-quotas.md) |
| Per-principal token-bucket quotas   | Stable     | §22.4  | [Audit & quotas](../operate/security/audit-and-quotas.md) |
| Ed25519 key rotation (dual-trust)   | Stable     | §22.2  | [Key rotation](../operate/security/key-rotation.md) |
| Container hardening (distroless, seccomp, non-root) | Stable | §22.6 | [Container hardening](../operate/security/container-hardening.md) |
...
| Quarantine garden (untrusted writes review) | Stable | §19 | [Federation Trust](../build/guides/federation-trust.md) |
...
|-------------------------------------|------------|----------------------------------------|
| MCP adapter (TypeScript)            | Stable     | [MCP / Claude Code](../build/connectors/index.md) |
| OpenClaw / Claude Code adapter      | Stable     | [OpenClaw](../build/connectors/openclaw.md) |
| Paperclip hook adapter              | Stable     | [Paperclip](../build/connectors/paperclip.md) |
| Cursor connector                    | Stable     | [Cursor](../build/connectors/cursor.md) |
| Zed connector                       | Stable     | [Zed](../build/connectors/zed.md) |
| Codex CLI connector                 | Stable     | [Codex CLI](../build/connectors/codex-cli.md) |
| Continue.dev connector              | Stable     | [Continue.dev](../build/connectors/continue-dev.md) |
| Gemini connector                    | Stable     | [Gemini](../build/connectors/gemini.md) |
| Ollama / LiteLLM connector          | Stable     | [Ollama / LiteLLM](../build/connectors/ollama-litellm.md) |
| Obsidian vault adapter (CLI/daemon) | Stable     | [Obsidian](../build/connectors/obsidian.md) |
| Obsidian community plugin           | Stable     | [Obsidian plugin](../build/connectors/obsidian-plugin.md) |
| Zep adapter                         | Stable     | [Zep](../build/connectors/zep.md) |
...
| Capability                          | Status     | Docs                                |
|-------------------------------------|------------|-------------------------------------|
| Python SDK (`stigmem-py`)           | Stable     | [Python SDK](../build/guides/python-sdk.md) |
...
Anything beyond these two milestones is in spec drafts under the [Spec section](../reference/spec/index.md) and is subject to scope changes.
