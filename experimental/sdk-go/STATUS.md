...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/sdk-go/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/sdk-go-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-sdk-go.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/sdk-go/` |
