...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/subscriptions-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-subscriptions.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/subscriptions/` |
