...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/billing/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/billing-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-billing.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/billing/` |
