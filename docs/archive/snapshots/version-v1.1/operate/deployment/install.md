...
For narrative runbooks covering Fly.io, Helm, systemd, PaaS, and backend selection, see **[Operating Stigmem → Deploy runbooks](../runbooks/deploy-runbooks)**.
:::
...
Then follow the [Quickstart](../../learn/quickstart/quickstart-tutorial) to complete the federation handshake and assert your first fact.
...
Nodes run on ports 8765–8768. See the [4-node federation guide](../../build/guides/federation-4node) for peer wiring, backpressure, and failure injection.
...
For macOS persistent service (LaunchAgent, no Docker), see [Installation](../../learn/quickstart/installation#running-as-a-persistent-service-macos).
