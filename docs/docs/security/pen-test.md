...
3. You report findings **privately** before public disclosure (see [§6 Disclosure Timeline](#6-disclosure-timeline)).
...
For a **4-node federation soak** including backpressure and scope-propagation invariants, see the [Federation: 4-Node Soak guide](../guides/federation-4node.md).
