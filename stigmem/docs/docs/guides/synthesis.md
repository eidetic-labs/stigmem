...
- [Decay guide](/docs/guides/decay) — apply configured decay policies before synthesizing for the cleanest view
- [Conflict resolution guide](/docs/guides/conflict-resolution) — resolve the contradictions synthesis surfaces
