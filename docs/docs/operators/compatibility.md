...
| Multi-tenant isolation | Experimental | (cross-cutting) | [`experimental/multi-tenant/`](https://github.com/Eidetic-Labs/stigmem/tree/main/experimental/multi-tenant) — source-only on `main`; no released plugin artifact yet |
