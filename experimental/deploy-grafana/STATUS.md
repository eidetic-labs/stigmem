...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/deploy-grafana/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/deploy-grafana-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-deploy-grafana.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/deploy-grafana/` |
