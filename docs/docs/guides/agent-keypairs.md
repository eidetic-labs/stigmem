...
Per-agent keypair registration is planned for Track C — Per-Principal Identity Hardening . This page is a stub. Content will be completed once the implementation lands.
:::
