"""Node metadata endpoint — spec §5.3 /.well-known/muninn."""
...
def node_metadata() -> dict[str, object]:
    ...
    return {
        ...
        "spec": "https://github.com/giganomix/muninn/blob/main/spec/muninn-spec-v0.3-draft.md",
    }
