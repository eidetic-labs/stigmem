...
The motivation is a set of daily-felt frictions observed running an agent-intensive company. From the [ACM-18 plan](/ACM/issues/ACM-18#document-plan):
...
### Phase 2 — Reference Node ✓ ([ACM-29](/ACM/issues/ACM-29))
...
### Phase 4 — Adapters (in flight) ([ACM-40](/ACM/issues/ACM-40))
...
The architecture reflects specific deliberate decisions, each documented in the [ACM-18 plan](/ACM/issues/ACM-18#document-plan) and sharpened by the Phase 0 surface read-back.
...
From the [ACM-18 plan](/ACM/issues/ACM-18#document-plan), unchanged and load-bearing for scope:
...
*Source citations: [ACM-18 plan](/ACM/issues/ACM-18#document-plan) · [ACM-19](/ACM/issues/ACM-19) (Phase 0) · [ACM-23](/ACM/issues/ACM-23) (Phase 1) · [ACM-29](/ACM/issues/ACM-29) (Phase 2) · [ACM-34](/ACM/issues/ACM-34) (Phase 3 exit memo) · [ACM-40](/ACM/issues/ACM-40) (Phase 4)*
