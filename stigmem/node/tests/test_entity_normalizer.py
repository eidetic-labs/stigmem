...
class TestNormalizeEntityUri:
    ...
    def test_formal_uppercase_id(self) -> None:
        assert normalize_entity_uri("stigmem://company.acme/issue/ACM-18") == "stigmem://company.acme/issue/acm-18"
    ...
    def test_formal_all_uppercase(self) -> None:
        assert (
            normalize_entity_uri("stigmem://COMPANY.ACME/PROJECT/ACM-18")
            == "stigmem://company.acme/project/acm-18"
        )
    ...
    def test_informal_issue_uppercase(self) -> None:
        assert normalize_entity_uri("issue:ACM-18") == "issue:acm-18"

    def test_informal_slash_uppercase(self) -> None:
        assert normalize_entity_uri("project/ACM-18") == "project/acm-18"

    def test_informal_slash_mixed(self) -> None:
        assert normalize_entity_uri("Project/ACM-phase4") == "project/acm-phase4"
    ...
    def test_idempotent_formal(self) -> None:
        uri = "stigmem://company.acme/issue/acm-42"
...
class TestIsInformal:
    ...
    def test_informal_slash(self) -> None:
        assert is_informal("project/acm-18")
...
class TestNormalizationOnIngest:
    ...
    def test_uppercase_entity_normalized_on_store(self, client: TestClient) -> None:
        ...
        assert r.json()["entity"] == "stigmem://company.acme/issue/acm-18"
    ...
    def test_informal_entity_lowercased_on_store(self, client: TestClient) -> None:
        ...
        assert r.status_code == 201
        assert r.json()["entity"] == "issue:acm-42"

    def test_case_variants_detect_contradiction(self, client: TestClient) -> None:
        """ACM-18 and acm-18 normalize to the same entity — should trigger contradiction."""
        fact = {
            "entity": "stigmem://company.acme/issue/ACM-99",
            "relation": "roadmap:status",
        ...
        fact2 = {**fact, "entity": "stigmem://company.acme/issue/acm-99", "value": {"type": "string", "v": "done"}}
