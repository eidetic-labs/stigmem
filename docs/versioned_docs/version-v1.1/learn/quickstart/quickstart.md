...
- [Assert facts guide](../../build/guides/asserting-facts.md) — full fact schema, scopes, and TTLs
- [Federation guide](../../build/guides/federation.md) — scope enforcement, conflict resolution, production keys
- [4-node topology](../../build/guides/federation-4node.md) — full-mesh setup, failure injection, soak metrics
