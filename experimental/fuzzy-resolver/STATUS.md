...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/fuzzy-resolver/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/fuzzy-resolver-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-fuzzy-resolver.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/fuzzy-resolver/` |
