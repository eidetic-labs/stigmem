...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/mcp-adapter/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/mcp-adapter-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-mcp-adapter.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/mcp-adapter/` |
