...
cd sdks/stigmem-ts
pnpm build
npm pack    # produces eidetic-labs-stigmem-ts-0.9.0-alpha.1.tgz

mkdir -p /tmp/stigmem-ts-smoke && cd /tmp/stigmem-ts-smoke
echo '{"name":"smoke","type":"module","private":true}' > package.json
npm install /Users/bjones/Desktop/stigmem/sdks/stigmem-ts/eidetic-labs-stigmem-ts-0.9.0-alpha.1.tgz
