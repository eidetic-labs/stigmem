...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/openai-tools-adapter/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/openai-tools-adapter-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-openai-tools-adapter.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/openai-tools-adapter/` |
