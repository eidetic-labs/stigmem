...
**Status:** DRAFT normative (v1.1-draft, v1.0 hardening)
...
**Status:** DRAFT normative (v1.0 hardening). §22.1–§22.7 carry MUST/SHOULD/MAY normative language.
