...
For a **4-node federation soak** including backpressure and scope-propagation invariants, see the [Federation: 4-Node Soak guide](../../build/guides/federation-4node.md).
