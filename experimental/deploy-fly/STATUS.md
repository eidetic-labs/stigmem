...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/deploy-fly/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/deploy-fly-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-deploy-fly.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/deploy-fly/` |
