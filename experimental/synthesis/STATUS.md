...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/synthesis/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/synthesis-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-synthesis.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/synthesis/` |
