...
Built against OpenClaw's public API surfaces only — no holdco outreach during the pre-v0.3 design window
...
#
# ### roadmap
# - **roadmap:constraint** on `project:acme-roadmap`: Must ship the v0.3 design window before 2026-06-01
#
# ### intent
