...
The joined audit log surface is planned for Track C — Per-Principal Identity Hardening ([ACM-87](/ACM/issues/ACM-87)). This page is a stub. Content will be completed once the implementation lands.
:::
