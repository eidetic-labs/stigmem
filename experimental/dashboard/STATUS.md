...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/dashboard/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/dashboard-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-dashboard.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/dashboard/` |
