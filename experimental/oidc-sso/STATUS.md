...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/oidc-sso/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/oidc-sso-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-oidc-sso.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/oidc-sso/` |
