...
const sidebars = {
  ...
  referenceSidebar: [
    ...
    // 'release-notes/v2.0' archived to 'release-notes/archive/v2.0' with
    // retraction header per master-checklist §4.3a. Not in sidebar; preserved
    // for external-link integrity. Per ADR-001, the v2.0 announcement was
    // withdrawn; the document is historical record, not roadmap content.
