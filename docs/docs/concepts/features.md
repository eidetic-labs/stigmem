...
| RTBF tombstones | Experimental opt-in plugin source extracted on `main`; default install has tombstone routes/filters inactive; artifact evidence queued | Spec-X2-RTBF-Tombstones |
