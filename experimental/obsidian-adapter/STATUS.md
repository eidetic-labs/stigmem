...
> Per [ADR-008](../../docs/adr/008-experimental-gates.md), gate status for `experimental/obsidian-adapter/`.
...
|---|---|---|---|---|
| 1 | Threat-model delta | Open | — | `spec/security/deltas/obsidian-adapter-threat-model.md` |
| 2 | ADR | Open | — | `docs/adr/NNN-obsidian-adapter.md` |
| 3 | Conformance vectors | Open | — | `data/conformance/obsidian-adapter/` |
