...
| [`stigmem-spec-v0.6-draft.md`](stigmem-spec-v0.6-draft.md) | v0.6 | Working draft | §2.5 Entity URI scheme (`stigmem://`) normative, §6.2 capability negotiation now required, §12 Adapter ABI normative (MCP, Paperclip, OpenClaw), §13 reserved for Phase 5+ |
...
| §13 Phase 5+ Reserved | — | — | — | — | Reserved | Synthesis, decay UI, contradiction tools |
...
The active development version is **v0.6-draft**. Sections §1–6, §8–11 are stable. §12 (Adapter ABI) is normative but under active Phase 4 implementation. §4 (Intent Envelope) remains draft and is not being implemented until Phase 5+.
