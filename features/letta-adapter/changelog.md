...
- Added ADR-020 feature record for the Letta adapter and made this directory
  the canonical location for adapter behavior, evidence, security posture, and
  release status.

## v0.9.0a1

- Tracked the Letta adapter as deferred experimental external adapter surface
